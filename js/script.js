...
Webflow.require('ix').init([
  {"slug":"sec2scrol","name":"Sec2scrol","value":{"style":{"opacity":0,"x":"0px","y":"200px","z":"0px"},"triggers":[{"type":"scroll","offsetBot":"10%","stepsA":[{"opacity":1,"transition":"transform 500ms ease 0, opacity 500ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  {"slug":"clouse","name":"clouse","value":{"style":{},"triggers":[{"type":"click","selector":".popup","stepsA":[{"display":"none","opacity":0,"transition":"opacity 500ms ease 0, transform 500ms ease 0"},{"display":"none"}],"stepsB":[]}]}},
  {"slug":"open","name":"open","value":{"style":{},"triggers":[{"type":"click","selector":".popup","stepsA":[{"display":"block","opacity":1,"transition":"opacity 500ms ease 0"},{"display":"block"}],"stepsB":[]}]}}
]);
